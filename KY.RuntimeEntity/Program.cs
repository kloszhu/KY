...
class Program
{
    static void Main() {
        ...
        Console.WriteLine(assembly.resultType.Name);
        Console.WriteLine(assembly.resultType.GetProperties().Count());
        Console.ReadKey();
    }
    ...
    //    tb.SetParent(typeof(BaseEntity));
    ...
    //    PropertyInfo ok = t.GetProperty("IsOk");
    ...
    //    Console.WriteLine("o1.IsOk: {0}", ok.GetValue(o1, null));
